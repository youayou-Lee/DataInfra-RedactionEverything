...
选样原则（覆盖矩阵，非凑数；每条 SELECTION 带理由）：
  ...
  - 大文件切 10-15 页片段（select 保留原始图像字节，不重采样），并同卷取首+中两段观察质量漂移；
...
SELECTION: list[dict] = [
    ...
    dict(id="real_cmf_evidence2_p1-15", src="陈明飞诈骗案/[证据卷]2.pdf", pages=(1, 15),
         category="hybrid_pdf", why="混合载体证据卷：真实文本层与扫描图混排，测载体路由"),
    dict(id="real_zqc_wenshu", src="曾庆成涉嫌危险驾驶案/[文书卷]曾庆成危险驾驶案（文书卷）.pdf", pages=None,
         category="scanned_pdf", why="小型纯扫描文书卷（15 页全文）：文字密集扫描件基线"),
    dict(id="real_ck_wenshu_p1-15",
         src="陈锟涉嫌诈骗、余会英涉嫌帮助信息网络犯罪活动案/[文书卷]陈锟、余会英诈骗案（文书卷）.pdf",
         pages=(1, 15), category="scanned_pdf", why="另一案件扫描文书卷：不同扫描仪质量对比"),
    dict(id="real_cqy_zj1_p1-15",
         src="陈朝郁、陈水金涉嫌盗窃骨灰案/[证据卷]陈朝郁、陈水金盗窃尸骨案（证据卷1）.pdf",
         pages=(1, 15), category="scanned_pdf", why="扫描证据卷：票据/收据类，盖章与手写噪声"),
    dict(id="real_chx_zj5_p1-15",
         src="陈海新、叶辉等5人涉嫌盗窃、掩饰隐瞒犯罪所得收益案/[其他卷]证据卷5.pdf",
         pages=(1, 15), category="scanned_pdf", why="大卷（214 页）首段"),
    dict(id="real_chx_zj5_p100-115",
         src="陈海新、叶辉等5人涉嫌盗窃、掩饰隐瞒犯罪所得收益案/[其他卷]证据卷5.pdf",
         pages=(100, 115), category="scanned_pdf", why="同卷中段：观察卷内扫描质量漂移"),
    dict(id="real_ck_zj6_p1-15", src="陈锟涉嫌诈骗、余会英涉嫌帮助信息网络犯罪活动案/[证据卷]陈锟、余会英诈骗案（证据卷六）.pdf",
         pages=(1, 15), category="scanned_pdf",
         why="诈骗案证据卷（MinerU 定位 356 处银行记录）：银行流水/转账凭证最密集的真实数字样本"),
    dict(id="real_ck_zj6_p60-75", src="陈锟涉嫌诈骗、余会英涉嫌帮助信息网络犯罪活动案/[证据卷]陈锟、余会英诈骗案（证据卷六）.pdf",
         pages=(60, 75), category="scanned_pdf", why="同卷中段：流水凭证主体区，与前段对比密度差异"),
    dict(id="real_zhb_hei_p1-15", src="zhuhaibin/光碟1/（11.16）朱健东、朱法生等25人参加黑社会性质组织、故意伤害等罪案.pdf",
         pages=(1, 15), category="scanned_pdf",
